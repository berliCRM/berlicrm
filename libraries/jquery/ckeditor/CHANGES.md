...
* [#12739](https://dev.ckeditor.com/ticket/12739): Fixed: Link loses inline styles when edited without the [Advanced Tab for Dialogs](https://ckeditor.com/cke4/addon/dialogadvtab) plugin. Thanks to [Ð’Ñ–Ñ‚Ð°Ð»Ñ–Ð¹ ÐšÑ€ÑƒÑ‚ÑŒÐºÐ¾](https://github.com/asmforce)!
* [#13292](https://dev.ckeditor.com/ticket/13292): Fixed: Protection pattern does not work in attribute in self-closing elements with no space before `/>`. Thanks to [Ð’Ñ–Ñ‚Ð°Ð»Ñ–Ð¹ ÐšÑ€ÑƒÑ‚ÑŒÐºÐ¾](https://github.com/asmforce)!
