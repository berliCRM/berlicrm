...
require_once('Exceptions/LoaderException.php');
...
abstract class Context
{
     ...
     * @var string
     */
    public static $loadedContext = '\\Contexts\\ContextMySql50700';
    ...
    public static function load($context = '')
    {
        if (empty($context)) {
			...
			$arrTmp = explode('\\', $context);
			$iContext = array_pop($arrTmp);
			require_once("Contexts/$iContext.php");
        }
