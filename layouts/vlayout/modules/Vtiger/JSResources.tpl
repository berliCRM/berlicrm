...
{* <script> resources below *}
	...
	<script type="text/javascript" src="libraries/jquery/autosize/autosize.min.js"></script>
	...
	{foreach key=index item=jsModel from=$SCRIPTS}
        <script type="{$jsModel->getType()}" src="{$jsModel->getSrc()}?v={$SVN_TAG}"></script>
	{/foreach}

	<!-- Added in the end since it should be after less file loaded -->
	<script type="text/javascript" src="libraries/bootstrap/js/less.min.js"></script>
	<!-- crm-now added for tool tip (display of help field contents -->
	<script>
