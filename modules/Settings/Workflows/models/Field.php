...
class Settings_Workflows_Field_Model extends Vtiger_Field_Model {
	...
	public static function getAdvancedFilterOpsByFieldType() {
		return array(
			...
			'currency' => array('equal to', 'less than', 'greater than', 'does not equal', 'less than or equal to', 'greater than or equal to', 'has changed', 'is empty', 'is not empty'),
			...
			'time' => array('is', 'is not', 'has changed', 'is empty', 'is not empty'),
			...
			'reference' => array('has changed', 'is', 'is not'),
			...
			'percentage' => array('equal to', 'less than', 'greater than', 'does not equal', 'less than or equal to', 'greater than or equal to', 'has changed', 'is empty', 'is not empty'),
		);
	}
