...
class Settings_Vtiger_SaveConfigTicketMail_Action extends Settings_Vtiger_Index_Action {
    ...
    public function process(Vtiger_Request $request) {
        ...
        $attachmentFolderId = $request->has('attachment_folder_id')
            ? (int)$request->get('attachment_folder_id')
            : $model->getAttachmentFolderId();
        ...
        $model->save($enabled, $senderEmail, $senderName, $replyToEmail, $replyToName, $attachmentFolderId);
