...
/**
 * Class Settings_Vtiger_ConfigEditorEditTicketMail_View
 *
 * Settings view controller responsible for rendering the
 * edit view of the global Ticket E-Mail sender configuration.
 *
 * Loads:
 *  - ConfigModule model (for navigation / block / field context)
 *  - ConfigTicketEmailAddress model (ticket mail sender data from DB)
 *
 * Renders template:
 *  - ConfigEditorEditTicketMail.tpl
 *
 * @package Settings
 * @subpackage Vtiger
 */
class Settings_Vtiger_ConfigEditorEditTicketEmailAddress_View extends Settings_Vtiger_Index_View {

	/**
	 * Process request and render the Ticket E-Mail edit view.
	 *
	 * Assigns required models and data to the viewer:
	 *  - MODEL (ConfigModule)
	 *  - TICKETMAIL_MODEL
	 *  - TICKETMAIL_DATA (array for tpl usage)
	 *  - QUALIFIED_MODULE
	 *  - CURRENT_USER_MODEL
	 *
	...
	public function process(Vtiger_Request $request) {
		...
		$ticketMailModel = Settings_Vtiger_ConfigTicketEmailAddress::getInstance();
		...
		$viewer->view('ConfigEditorEditTicketEmailAddress.tpl', $qualifiedName); 
	}

	/**
	 * Returns page title for the Ticket E-Mail edit view.
	 *
	 * @param Vtiger_Request $request
	 * @return string
	 */
