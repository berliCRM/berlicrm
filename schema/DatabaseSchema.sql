...
(23, 581, 's_h_percent', 'vtiger_invoice', 1, '1', 'hdnS_H_Percent', 'S&H Percent', 0, 2, '', 100, 10, 88, 5, 'N~O', 0, 1, 'BAS', 0, '', 0),
(20, 582, 's_h_percent', 'vtiger_quotes', 1, '1', 'hdnS_H_Percent', 'S&H Percent', 0, 2, '', 100, 10, 91, 5, 'N~O', 0, 1, 'BAS', 0, '', 0),
(21, 583, 's_h_percent', 'vtiger_purchaseorder', 1, '1', 'hdnS_H_Percent', 'S&H Percent', 0, 2, '', 100, 10, 90, 5, 'N~O', 0, 1, 'BAS', 0, '', 0),
(22, 584, 's_h_percent', 'vtiger_salesorder', 1, '1', 'hdnS_H_Percent', 'S&H Percent', 0, 2, '', 100, 10, 89, 5, 'N~O', 0, 1, 'BAS', 0, '', 0),
...
CREATE TABLE IF NOT EXISTS `vtiger_notes` (
  ...
  `notecontent` text COLLATE utf8_unicode_ci,
