...
('Public', 'Ticket Antwort', '$helpdesk-ticket_no$ [Ticket ID: $helpdesk-ticketid$] $helpdesk-title$', 'In diesem Template können Platzhalter (Variablen) verwendet werden, die beim Versand automatisch durch aktuelle Ticket-, Kommentar- und Unternehmensdaten ersetzt werden. Die Variablen müssen exakt wie angegeben (inklusive der Dollarzeichen $) im Template verwendet werden. <br /> <br /> HINWEISE Nicht vorhandene oder falsch geschriebene Variablen werden nicht ersetzt und bleiben im Text sichtbar.', '<table border="0" cellpadding="0" cellspacing="0" style="background:#F5F7FB;padding:24px 0;" width="100%"><tbody><tr><td align="center" style="padding:0 12px;"><table border="0" cellpadding="0" cellspacing="0" style="width:600px;max-width:600px;background:#FFFFFF;" width="600"><tbody><tr><td style="background:#14489D;padding:18px 22px;"><table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td align="left" style="vertical-align:middle;"><img alt="$custom-companyname$" border="0" src="$custom-logo$" style="height:auto;max-width:140px;" width="140" /></td><td align="right" style="font-family:Arial, Helvetica, sans-serif;color:#FFFFFF;font-size:12px;vertical-align:middle;">$custom-currentdate$</td></tr></tbody></table></td></tr><tr><td style="padding:22px;font-family:Arial, Helvetica, sans-serif;color:#101828;"><div style="font-size:16px;line-height:24px;margin:0 0 14px 0;">Hallo $contacts-firstname$ $contacts-lastname$$accounts-accountname$,</div><div style="font-size:14px;line-height:22px;margin:0 0 14px 0;color:#344054;">Ihr Vorgang, mit der Ticketnummer<strong style="color:#101828;"> $helpdesk-ticket_no$</strong>, hat einen neuen Kommentar:</div><div style="font-size:14px;line-height:22px;margin:0 0 16px 0;color:#344054;">$modcomments-commentcontent$</div><table border="0" cellpadding="0" cellspacing="0" style="background:#F9FAFB;border:1px solid #EAECF0;" width="100%"><tbody><tr><td style="padding:14px 14px;"><div style="font-size:13px;line-height:20px;color:#475467;"><strong style="color:#101828;">Betreff:</strong> $helpdesk-title$<br /><strong style="color:#101828;">Status:</strong> $helpdesk-status$<br /><strong style="color:#101828;">Beschreibung:</strong> $helpdesk-description$</div></td></tr></tbody></table><table border="0" cellpadding="0" cellspacing="0" style="margin:18px 0 8px 0;"><tbody><tr><td bgcolor="#14489D"><a href="$custom-kundenportallink$" style="padding:12px 16px;font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#FFFFFF;text-decoration:none;font-weight:700;">Ticket im Portal ansehen</a></td></tr></tbody></table><div style="font-size:12px;line-height:18px;color:#667085;margin:0 0 10px 0;">Falls der Button nicht funktioniert, nutzen Sie diesen Link:<br /><a href="$custom-kundenportallink$" style="color:#14489D;text-decoration:underline;">$custom-kundenportallink$</a></div><hr style="border:none;border-top:1px solid #EAECF0;margin:18px 0;" /><div style="font-size:14px;line-height:22px;color:#101828;margin:0;"><span style="color:#475467;">Mit freundlichen Grüßen<br /><br />crm-now Team</span></div><div style="font-size:12px;line-height:18px;color:#667085;margin-top:12px;"><a style="color:#14489D;text-decoration:underline;">$custom-website$</a> • $custom-phone$ • <a href="mailto:$custom-supportemail$" style="color:#14489D;text-decoration:underline;">$custom-supportemail$</a></div></td></tr><tr><td style="padding:14px 22px;background:#F9FAFB;font-family:Arial, Helvetica, sans-serif;color:#667085;font-size:12px;line-height:18px;">Sie erhalten diese E-Mail, weil Sie ein Support-Ticket bei $custom-companyname$ erstellt haben.<br />© $custom-currentyear$ $custom-companyname$ • $custom-address$</td></tr></tbody></table><div style="height:16px;line-height:16px;"> </div><div style="max-width:600px;font-family:Arial, Helvetica, sans-serif;font-size:11px;color:#98A2B3;line-height:16px;text-align:center;">Hinweis: Bitte antworten Sie direkt auf diese E-Mail, falls Sie weitere Informationen ergänzen möchten.</div></td></tr></tbody></table>', 0, 3);
