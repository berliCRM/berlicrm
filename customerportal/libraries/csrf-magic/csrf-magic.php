 ...
 */
$GLOBALS['csrf']['cookie'] = '__cpfck'; // __csrf_cookie
 ...
 */
$GLOBALS['csrf']['input-name'] = '__cpftk'; // __csrf_magic
 ...
 */
$GLOBALS['csrf']['frame-breaker'] = false; // To be more STRICT set this to true;
