...
Settings_Vtiger_List_Js("Settings_SMSNotifier_List_Js",{
			...
			function(data) {
				...
				var callBackFunction = function(data) {
					...
					params.onValidationComplete = function(form, valid){
						if(valid) {
							var providerFields = jQuery('.configContent div:visible').find("select,input");
							var recordId= jQuery('#recordId').val();
							thisInstance.saveConfiguration(providerFields,recordId).then(
								function(data) {
									if(data['success']) {
										var params = {};
	 ...
	 */
	saveConfiguration : function(providerFields,recordId) {
		var thisInstance = this;
		...
		var params = [];
		var configfields = providerFields.serialize();

		params['record'] = recordId;
		params['configfields'] = configfields;
