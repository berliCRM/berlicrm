...
<div data-role="page" data-theme="b" id="home_page">
	<div data-role="header" data-theme="b" data-position="fixed" class="ui-grid-b ui-responsive">
		...
		<h4>{vtranslate('LBL_MOD_LIST',{'Mobile'})}</h4>
	</div><!-- /header -->
	<div  data-role="fieldcontain" data-mini="true">
		...
		{/literal}
		<form  name="form"  method="post" action="?_operation=globalsearch&module={$_MODULES[0]->name()}">
			...
			<a data-role="button" data-inline="true" class="ui-grid-b ui-responsive" data-mini='true' href="#" onclick="fn_submit();" target="_self" >{vtranslate('LBL_SEARCH',{'Mobile'})}</a>
        </form>
	</div>
