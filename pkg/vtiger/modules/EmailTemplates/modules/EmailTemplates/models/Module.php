...
class EmailTemplates_Module_Model extends Vtiger_Module_Model {
    ...
    public function getAllModuleEmailTemplateFields($fieldModule='') {
        ...
        $allFields[] = $option;
        $option = array(vtranslate('LBL_SUPPORT_EMAIL'), '$custom-supportemail$');
        $allFields[] = $option;
        $option = array(vtranslate('LBL_COMPANY_LOGO'), '$custom-logo$');
        $allFields[] = $option;
        $option = array(vtranslate('LBL_COMPANY_NAME'), '$custom-companyname$');
        $allFields[] = $option;
        $option = array(vtranslate('LBL_COMPANY_WEBSITE'), '$custom-website$');
        $allFields[] = $option;
        $option = array(vtranslate('LBL_COMPANY_ADDRESS'), '$custom-address$');
        $allFields[] = $option;
        $option = array(vtranslate('LBL_COMPANY_CITY'), '$custom-city$');
        $allFields[] = $option;
        $option = array(vtranslate('LBL_COMPANY_STATE'), '$custom-state$');
        $allFields[] = $option;
        $option = array(vtranslate('LBL_COMPANY_COUNTRY'), '$custom-country$');
        $allFields[] = $option;
        $option = array(vtranslate('LBL_COMPANY_PHONE'), '$custom-phone$');
        $allFields[] = $option;
        $option = array(vtranslate('LBL_COMPANY_FAX'), '$custom-fax$');
        $allFields[] = $option;
        $option = array(vtranslate('Customerportal Link'), '$custom-customerportallink$');
        $allFields[] = $option;
        $option = array(vtranslate('Kundenportal Link'), '$custom-kundenportallink$');
        $allFields[] = $option;
