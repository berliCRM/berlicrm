...
$languageStrings = array(
	...
	'LBL_NEW_LOCAL_ENTRIES_TO_EXPORT'=>'Export new local entries:',
	'LBL_FINISHED_AFTER'=>'Synchronisation finished after %s seconds.',
	...
	'LBL_PLEASE_WAIT'=>'Please wait. Depending on the size of your list, the next operation can last up to 15 minutes.',
	...
	'LBL_INTERESTGROUP_FAILED'=>'Missing interests group in Mailchimp. Please set an interests group in Mailchimp for the synchronization.',
	...
	'LBL_NEW_CONTACTS_IMPORTED'=>'New Mailchimp entries imported as contacts:',
	'LBL_NEW_LEADS_IMPORTED'=>'New Mailchimp entries imported as leads:',
	...
	'LBL_VERBOSELOG_DELETE'=>'CRM entry &raquo;%s&laquo; deleted, <b>DELETE FROM MAILCHIMP</b>',
	'LBL_VERBOSELOG_NOEXPORTONOPTOUT'=>'CRM entry %s not on Mailchimp, but has EmailOptOut set! <b>NO EXPORT</b>',
	'LBL_VERBOSELOG_DELETEDREMOTELY'=>'CRM entry %s deleted remotely. <b>REMOVE FROM CRM GROUP</b>',
	'LBL_VERBOSELOG_EXPORT'=>'CRM-entry %s not yet on Mailchimp. <b>EXPORT</b>',
	'LBL_VERBOSELOG_ADDTOCRMGROUP'=>'Mailchimp entry %s present in CRM but not yet in sync group. <b>ADD TO SYNC GROUP</b>',
	'LBL_VERBOSELOG_TEST4IMPORT'=>'Mailchimp entry %s not yet in CRM.',
	'LBL_VERBOSELOG_INACTIVE'=>' Mailchimp entry is inactive.',
    'LBL_VERBOSELOG_TYPEBLOCKED'=>'Mailchimp entry &raquo;%s&laquo; is blocked in the CRM for type &raquo;%s&laquo;. <b>SKIP</b>',
	'LBL_VERBOSELOG_INCOMPLETE'=>' Is incomplete!',
	'LBL_VERBOSELOG_DOIMPORT'=>' <b>IMPORT</b>',
	'LBL_VERBOSELOG_DONTIMPORT'=>' <b>NO IMPORT</b>',
	'LBL_VERBOSELOG_HAVEENTRY'=>'Mailchimp entry %s present in CRM and sync group.',
	'LBL_VERBOSELOG_UNSUBSCRIBED'=>' <b>UNSUBSCRIBED on %s</b>',
	'LBL_VERBOSELOG_BOUNCED'=>' <b>BOUNCED, blocked since %s</b>',
	...
	'LBL_API_ERROR'=>'Faulty Mailchimp API response. Please try again.',
	'LBL_API_TIMEOUT_ACT'=>'API timeout - Please try again.',
	'LBL_API_AUTH_ERROR'=>'API not authorized',
	'LBL_API_AUTH_ERROR_ACT'=>'Please check your Mailchimp settings.',
	'LBL_API_CONNECTED_TO'=>'Successfully connected to Mailchimp API Account #%s of %s %s',

	'LBL_GOT_ALL_MEMBERS_CRM_MAILCHIMP'=>'Fetched all entries of CRM group &raquo;%s&laquo; (ID %s).',
	'LBL_GOT_ALL_MEMBERS_MAILCHIMP_API'=>'Fetched all entries of Mailchimp group <b>%s</b> (ID %s).',
	'LBL_MAILCHIMP_ATTRIB_CREATED'=>'All neccessary attributes are created on  Mailchimp.',
	'LBL_MAILCHIMP_ATTRIB_OK'=>'All neccessary attributes are present on Mailchimp.',
