...
<div data-role="page" data-theme="b" id="detail_page">
	...
	<div  data-role="header" data-theme="{$COLOR_HEADER_FOOTER}" data-position="fixed">
		...
		{/if}
			<h2></h2>
			<a href="index.php?_operation=listModuleRecords&module={$_MODULE->name()}" class="ui-btn ui-corner-all ui-icon-bullets ui-btn-icon-notext"  rel=external>{vtranslate('LBL_LISTVIEW', 'crmtogo')}</a>
	</div>
	{else}
	<div data-role="header" data-theme="{$COLOR_HEADER_FOOTER}" data-position="fixed">
		...
		<h2></h2>
			<a href="index.php?_operation=listModuleRecords&module={$_MODULE->name()}" class="ui-btn ui-btn-right ui-corner-all ui-icon-bullets ui-btn-icon-notext"  rel=external>{vtranslate('LBL_LISTVIEW', 'crmtogo')}</a>
	</div>
	{/if}
	<div>
